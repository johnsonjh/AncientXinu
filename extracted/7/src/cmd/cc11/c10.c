...
#ifdef	vax
		printf(".data\nL%d:%o;%o;%o;%o\n.text\n", p1->value,
			p1->fvalue.intx[0] & 0xffff,
			p1->fvalue.intx[1] & 0xffff,
			p1->fvalue.intx[2] & 0xffff,
			p1->fvalue.intx[3] & 0xffff);
#else
		printf(".data\nL%d:%o;%o;%o;%o\n.text\n", p1->value, p1->fvalue);
#endif
		p1->value = -p1->value;
...
#ifdef	vax
			printf(".data\nL%d:%o;%o;%o;%o\n.text\n", p2->value,
				p2->fvalue.intx[0] & 0xffff,
				p2->fvalue.intx[1] & 0xffff,
				p2->fvalue.intx[2] & 0xffff,
				p2->fvalue.intx[3] & 0xffff);
#else
			printf(".data\nL%d:%o;%o;%o;%o\n.text\n", p2->value, p2->fvalue);
#endif
			p2->value = -p2->value;
