...
char	DIR[]		= "/usr/Xinu",
	CPP[]		= "/usr/Xinu/lib/cpp11",
	C0[]		= "/usr/Xinu/lib/c0.11",
	C1[]		= "/usr/Xinu/lib/c1.11",
	C2[]		= "/usr/Xinu/lib/c2.11",
	AS[]		= "/usr/Xinu/bin/as11",
	ASDEFS[]	= "/usr/Xinu/include/sys.s",
	LD[]		= "/usr/Xinu/bin/ld11",
	CRT[]		= "/usr/Xinu/lib/xinu.o",
	*crtptr = CRT,
	LIBS[]		= "/usr/Xinu/lib/libx.a /usr/Xinu/lib/libxc.a /usr/Xinu/lib/libx.a",
	*libptr = LIBS,
	STANDLIB[]	= "/usr/Xinu/lib/standalone/libsa.a",
	STANDCRT[]	= "/usr/Xinu/lib/standalone/lowcore.o /usr/Xinu/lib/standalone/startup.o";
