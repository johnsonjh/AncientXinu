        ...
        char *fmt;
{
        ...
        doprnt(fmt, &args, putc, CSR);
}

/*----------------------------------------------------------------------
 *  fprintf  --  unbuffered output to arbitrary serial line device
 *----------------------------------------------------------------------
 */
