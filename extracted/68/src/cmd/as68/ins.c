...
{	register int i;		/* gen purpose index */
	...
	if (Cur_csect==Text_csect && (Dot&1)) Prog_Error(E_ODDADDR);
...
/* miscellaneous classes */
	...
	case i_data1:	New_Csect(Data1_csect); goto pseudo;
	case i_data2:	New_Csect(Data2_csect); goto pseudo;
	...
	case i_asciz:	Ascii(1); goto pseudo;
        case i_stabs:   goto pseudo;
        case i_stabd:   goto pseudo;
        case i_set:     goto pseudo;			/* yip - .set */
        case i_skip:    Skip(); goto pseudo;
