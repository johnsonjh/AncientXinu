...
extern long Dot,tsize,dsize,d1size,d2size,bsize;
extern struct csect *Cur_csect,*Text_csect,*Data_csect,*Data1_csect;
extern struct csect *Data2_csect,*Bss_csect;
